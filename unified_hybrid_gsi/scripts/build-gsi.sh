#!/bin/bash
# =============================================================================
# build-gsi.sh (Unified Master Re-packager)
# =============================================================================
...
IMAGE_SIZE="512M" # Only the Bootstrapper bindings exist inside the generic system GSI
...
# Assemble the precise logic into the Ext4 container leaving userdata squashfs bounds outside
...
rm -f "$TEMP_IMAGE"
echo "=== Generic Image $OUTPUT_IMAGE packaged! ==="
